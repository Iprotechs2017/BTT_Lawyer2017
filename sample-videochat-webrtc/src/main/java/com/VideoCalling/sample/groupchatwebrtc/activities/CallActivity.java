...
import com.VideoCalling.sample.groupchatwebrtc.fragments.BaseConversationFragment;
import com.VideoCalling.sample.groupchatwebrtc.fragments.AudioConversationFragment;
import com.VideoCalling.sample.groupchatwebrtc.fragments.VideoConversationFragment;
import com.VideoCalling.sample.groupchatwebrtc.fragments.ConversationFragmentCallbackListener;
import com.VideoCalling.sample.groupchatwebrtc.fragments.IncomeCallFragment;
import com.VideoCalling.sample.groupchatwebrtc.fragments.OnCallEventsController;
import com.VideoCalling.sample.groupchatwebrtc.fragments.IncomeCallFragmentCallbackListener;
import com.VideoCalling.sample.groupchatwebrtc.services.WebService;
import com.VideoCalling.sample.groupchatwebrtc.util.NetworkConnectionChecker;
import com.VideoCalling.sample.groupchatwebrtc.utils.Consts;
import com.VideoCalling.sample.groupchatwebrtc.utils.FragmentExecuotr;
...
import com.VideoCalling.sample.groupchatwebrtc.utils.RingtonePlayer;
...
public class CallActivity extends BaseActivity implements QBRTCClientSessionCallbacks, QBRTCSessionConnectionCallbacks, QBRTCSignalingCallback,
    ...
    private MediaProjectionCallback1 mMediaProjectionCallback;
    ...
    private void startRecording() {
      ...
      //  Toast.makeText(CallActivity.this,"Start",Toast.LENGTH_LONG).show();
        //   startRecord.setText("stopRecord");
        initRecorder();
        shareScreen();
    }
    @Override
    ...
    private VirtualDisplay createVirtualDisplay() {
        return mMediaProjection.createVirtualDisplay("CallActivity",
   ...
   //     Toast.makeText(CallActivity.this,"Call Recorded Successfully...",Toast.LENGTH_LONG).show();
      //  startActivity(new Intent(CallActivity.this,UplodeActivity.class).putExtra("filePath",videoPath));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        mMediaProjectionCallback = new MediaProjectionCallback1();
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    class MediaProjectionCallback1 extends MediaProjection.Callback {
        @Override
        public void onStop() {
           /* if (mToggleButton.isChecked()) {
            ...
            Toast.makeText(CallActivity.this, "Sharing Stopped...!", Toast.LENGTH_SHORT).show();
            mMediaProjection = null;
            try {
                stopScreenSharing();
            }
        ...
        try {
            ...
            videoPath = Environment
                    .getExternalStoragePublicDirectory(Environment
                            .DIRECTORY_DOWNLOADS) + "/VideoCall"+timeStamp.toString()+".mp4";
    ...
    @Override
            ...
            else
      {
          stopRecording();
          destroyMediaProjection();
          startService(new Intent(CallActivity.this, WebService.class).putExtra("path",videoPath));
      }
        }
        catch (Exception e)
        {
