package com.VideoCalling.sample.groupchatwebrtc.db;
...
public static ArrayList opponentsNames=new ArrayList();
    ...
    public void saveUser(QBUser qbUser) {
       SharedPreferences qb = mContext.getSharedPreferences("QB", MODE_PRIVATE);
       if(qbUser.getId()!=qb.getInt("qbUserId",-1)) {
           ContentValues cv = new ContentValues();
           DbHelper dbHelper = new DbHelper(mContext);
           SQLiteDatabase db = dbHelper.getWritableDatabase();
           opponentsNames.add(qbUser.getFullName());
